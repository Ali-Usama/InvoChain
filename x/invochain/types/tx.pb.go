...
// source: invochain/invochain/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "invochain.invochain.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "invochain.invochain.MsgCreatePostResponse")
	proto.RegisterType((*MsgUpdatePost)(nil), "invochain.invochain.MsgUpdatePost")
	proto.RegisterType((*MsgUpdatePostResponse)(nil), "invochain.invochain.MsgUpdatePostResponse")
	proto.RegisterType((*MsgDeletePost)(nil), "invochain.invochain.MsgDeletePost")
	proto.RegisterType((*MsgDeletePostResponse)(nil), "invochain.invochain.MsgDeletePostResponse")
}

func init() { proto.RegisterFile("invochain/invochain/tx.proto", fileDescriptor_bead3ac13f5b4684) }
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/invochain.invochain.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdatePost(ctx context.Context, in *MsgUpdatePost, opts ...grpc.CallOption) (*MsgUpdatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/invochain.invochain.Msg/UpdatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeletePost(ctx context.Context, in *MsgDeletePost, opts ...grpc.CallOption) (*MsgDeletePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/invochain.invochain.Msg/DeletePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/invochain.invochain.Msg/CreatePost",
	}
...
func _Msg_UpdatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/invochain.invochain.Msg/UpdatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeletePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/invochain.invochain.Msg/DeletePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "invochain.invochain.Msg",
	...
	Metadata: "invochain/invochain/tx.proto",
}
