...
func init() {
	...
	proto.RegisterType((*QueryGetPostRequest)(nil), "invochain.invochain.QueryGetPostRequest")
	proto.RegisterType((*QueryGetPostResponse)(nil), "invochain.invochain.QueryGetPostResponse")
	proto.RegisterType((*QueryAllPostRequest)(nil), "invochain.invochain.QueryAllPostRequest")
	proto.RegisterType((*QueryAllPostResponse)(nil), "invochain.invochain.QueryAllPostResponse")
}
...
func (c *queryClient) Post(ctx context.Context, in *QueryGetPostRequest, opts ...grpc.CallOption) (*QueryGetPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/invochain.invochain.Query/Post", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PostAll(ctx context.Context, in *QueryAllPostRequest, opts ...grpc.CallOption) (*QueryAllPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/invochain.invochain.Query/PostAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Post_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/invochain.invochain.Query/Post",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PostAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/invochain.invochain.Query/PostAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
